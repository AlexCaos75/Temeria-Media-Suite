...
(function(){
  ...
  function computeLook(state){
    ...
    return { size, cardBackground, cardTextColor, titleColor, mainTextColor, titleTextShadow, mainTextShadow, mainFontStyle, mainLetterSpacing, extraStyle, cardWidth, cardRadius, cardPadding, minHeight };
  }
...
<div class="temeria-public-root" style="position:relative;max-width:1200px;margin:auto;padding-top:30px;">
  ...
  ">
    ...
    <h1 style="font-size:${look.size.titleSize};margin-bottom:20px;font-family:Orbitron,Arial,sans-serif;letter-spacing:2px;color:${look.titleColor};text-shadow:${look.titleTextShadow};">${html(state.content.title)}</h1>

    <div style="font-size:${look.size.textSize};line-height:1.7;max-width:700px;margin:auto;color:${look.mainTextColor};font-style:${look.mainFontStyle};letter-spacing:${look.mainLetterSpacing};text-shadow:${look.mainTextShadow};">${br(state.content.phrase)}</div>
